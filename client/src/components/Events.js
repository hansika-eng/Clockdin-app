...
const hardcodedEvents = [
 ...
 const Events = () => {
  ...
  useEffect(() => {
    fetch("https://clockdin.onrender.com/api/events")
      .then((res) => res.json())
      .then((data) => {
  ...
  const filteredEvents = events.filter((event) => {
    ...
    return activeCategory in typeMap ? eventType === typeMap[activeCategory] : true;
  });
  ...
  const handleBookmark = (event) => {
    ...
    if (!updated.includes(event._id)) {
      ...
      localStorage.setItem(
        ...
        JSON.stringify(all.filter((e) => e._id !== event._id))
      );
    }
  };
        ...
        <div className="col-lg-9 col-12 events-main">
          <div className="p-3">
            <div className="events-hero text-center">
              ...
              {/* Categories & Tabs UI omitted for brevity, same as before */}
            </div>
